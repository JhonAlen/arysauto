...
@Component({
  selector: 'app-provider-bank',
  templateUrl: './provider-bank.component.html',
  styleUrls: ['./provider-bank.component.css']
})
export class ProviderBankComponent implements OnInit {
